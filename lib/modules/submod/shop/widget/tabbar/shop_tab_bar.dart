...
class ShopTabBar extends StatefulWidget {
  const ShopTabBar({super.key, required this.tabs, required this.controller});

  final List<TabModel> tabs;
  final TabController controller;

  @override
  State<ShopTabBar> createState() => ShopTabBarState();
}

class ShopTabBarState extends State<ShopTabBar> {
  int _currentIndex = 0;
